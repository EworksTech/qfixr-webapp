          ...
          <div class="navbar-inner">
            ...
            <div class="nav-collapse collapse">
              <ul class="nav pull-right">
                ...
                <li class="active" ><a href="<?php echo site_url('chamados')?>">Chamados</a></li>
                 <li class="divider-vertical"></li>
  ...
  <div class="row-fluid">
    ...
    <div class="span10">
        ...
        <?php 
			 	 ...
			 	 foreach ($dbchamados as $calls_item){ 
					echo "<tr>";
						echo "<td>".$calls_item['id']."</td>";
						//echo "<td><a href='".site_url('clientes/edit/'.$clients_item['id'])."'>".$clients_item['nome']."</a></td>";
						echo "<td>".$calls_item['cliente']."</td>";
						echo "<td>".$calls_item['descricao']."</td>";
						echo "<td>".$calls_item['agendar']."</td>";
