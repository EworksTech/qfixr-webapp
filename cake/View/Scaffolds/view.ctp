...
<?php
	...
	echo "\t\t<li>";
	echo $this->Form->postLink(__d('cake', 'Delete %s', __($singularHumanName)), array('action' => 'delete', ${$singularVar}[$modelClass][$primaryKey]), null, __d('cake', 'Are you sure you want to delete # %s?', ${$singularVar}[$modelClass][$primaryKey]));
	echo " </li>\n";
...
<div class="related">
	<h3><?php echo __(__("Related %s", Inflector::humanize($_details['controller']))); ?></h3>
